...
def image_processing_test_examples():
    ...
    img_save("img/out/dsc20_negated.png", negative_dsc20_img)
    ...
    rotated_img = IP.rotate_180(dsc20_img)
    img_save("img/out/dsc20_rotated.png", rotated_img)

    # crops image
    cropped_img = IP.crop(dsc20_img, 100, 50, (100, 150))
    img_save("img/out/dsc20_cropped.png", cropped_img)

    # tint image
    tinted_img = IP.tint(dsc20_img, color=(0,0,100))
    img_save("img/out/dsc20_tinted.png", tinted_img)

    # cleared channel image
    cleared_channel_1_img = IP.clear_channel(dsc20_img, 0)
    img_save("img/out/dsc20_clear_channel_1.png", cleared_channel_1_img)

    cleared_channel_2_img = IP.clear_channel(dsc20_img, 1)
    img_save("img/out/dsc20_clear_channel_2.png", cleared_channel_2_img)
